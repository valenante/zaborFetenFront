      ...
      {mostrarTamaño && plato.nombre !== 'Surtido de Croquetas' && (plato.precios.tapa || plato.precios.racion || plato.precios.precio) && (
        <FormControl fullWidth margin="normal">
          ...
          <Select
            ...
            label="Tamaño"
          >
            {plato.precios.tapa && <MenuItem value="tapa" translate="no">Tapa - ${plato.precios.tapa}</MenuItem>}
            {plato.precios.racion && <MenuItem value="racion" translate="no">Ración - ${plato.precios.racion}</MenuItem>}
